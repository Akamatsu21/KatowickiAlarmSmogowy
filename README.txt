...
Autorzy:
Weronika Ziemianek (Grafika/Product Management)
...
Przy kompilacji domyœlna jest wersja user. Jeœli chcemy skompilowaæ wersjê admin nale¿y odkomentowaæ fragment kodu zajmuj¹cy siê wysy³aniem emaili (znajduje siê on w pliku MainWindow.xaml.cs, na koñcu konstruktora), a tak¿e umieœciæ dwa pliki tekstowe w folderze z exekiem:
...
Credentials.txt - zawieraj¹cy w pierwszej linijce nazwê u¿ytkownika, a w drugiej has³o do adresu email z którego emaile maj¹ byæ wysy³ane (kod obs³uguje tylko adresy Gmail).